...
def main() -> None:
    """Calculate local force constant."""
    # Add arguments
    ...
    parser.add_argument(
        ...
        "--method",
        type=str,
        help='Method: "local" (default) or "compliance"',
        default="local",
    )
    parser.add_argument(
        "-p", "--program", type=str, help="Quantum-chemical program", required=True
    )
    parser.add_argument("-t", "--type", type=str, help="Filetype", required=True)
    parser.add_argument("-x", "--xyz", type=str, help="xyz file")
